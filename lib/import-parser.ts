...
export function validateRow(
  ...
  const base: ImportRow = {
    ...
    area,
    sub_region: String(raw.sub_region ?? "").trim() || undefined,
    ...
    discount_scheme: String(raw.discount_scheme ?? "").trim() || undefined,
    discount_type: String(raw.discount_type ?? "").trim() || undefined,
    discount_value: parseNumberOrUndefined(raw.discount_value),
    discount_weekday_type: String(raw.discount_weekday_type ?? "").trim() || undefined,
    discount_weekday_value: parseNumberOrUndefined(raw.discount_weekday_value),
    discount_friday_sunday_type: String(raw.discount_friday_sunday_type ?? "").trim() || undefined,
    discount_friday_sunday_value: parseNumberOrUndefined(raw.discount_friday_sunday_value),
    discount_saturday_holiday_type: String(raw.discount_saturday_holiday_type ?? "").trim() || undefined,
    discount_saturday_holiday_value: parseNumberOrUndefined(raw.discount_saturday_holiday_value),
    pool: parseBool(raw.pool),
    near_beach: parseBool(raw.near_beach),
    sea_view: parseBool(raw.sea_view),
    near_lake: parseBool(raw.near_lake),
    karaoke: parseBool(raw.karaoke),
    bbq: parseBool(raw.bbq),
    pickleball: parseBool(raw.pickleball),
