...
export function validateRow(
  ...
  const base: ImportRow = {
    ...
    discount_weekend_type: String(raw.discount_weekend_type ?? "").trim() || undefined,
    discount_weekend_value: parseNumberOrUndefined(raw.discount_weekend_value),
